...
//グローバル変数
//+++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++
LPDIRECT3DTEXTURE9 g_pTexturebackgraund = NULL;						//テクスチャへのポインタ
...
void Initbackgraund(void)
{
	...
	//頂点バッファの生成
	pDevice2->CreateVertexBuffer(sizeof(VERTEX_2D) * 4,
		D3DUSAGE_WRITEONLY,
		FVF_VERTEX_2D,
		D3DPOOL_MANAGED,
...
void Uninitbackgraund(void)
{
	...
	//for (nCntbackgraund = 0; nCntbackgraund < NUM_BACKGURAUND; nCntbackgraund++)
	//{
		//if (g_pTexturebackgraund[nCntbackgraund] != NULL)
		//{
		//	g_pTexturebackgraund[nCntbackgraund]->Release();
		//	g_pTexturebackgraund[nCntbackgraund] = NULL;
		//}

	//}
	//テクスチャの破棄
	if (g_pTexturebackgraund != NULL)
...
void Drawbackgraund(void)
{
	...
	//{
		//テクスチャの設定
		pDevice2->SetTexture(0,	g_pTexturebackgraund);				
